  ...
  describe "POST create" do
    context "with authenticated user" do
      ...
      context "with valid inputs" do
        before do
          post :create, params: { entry: Fabricate.attributes_for(:entry), user_id: current_user.id }
        end
      ...
      context "with invalid inputs" do
        before do
          post :create, params: { entry: Fabricate.attributes_for(:entry, skill: nil), user_id: current_user.id }
        end
