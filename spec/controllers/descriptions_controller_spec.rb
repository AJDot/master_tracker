describe DescriptionsController, type: :controller do
  ...
  describe "POST create" do
    context "with authenticated users" do
      ...
      context "with valid inputs" do
        before do
          post :create, params: { description: { name: "new_description" }, user_id: current_user.username }
        end
      ...
      context "with invalid inputs" do
        before do
          post :create, params: { description: { name: "" }, user_id: current_user.username }
        end
  ...
  describe "GET edit" do
    ...
    context "with unauthenticated user" do
      ...
      before do
        get :edit, params: { id: description.token, user_id: user.id }
      end
  ...
  describe "PATCH update" do
    context "with authenticated user" do
      ...
      context "with valid inputs" do
        before do
          patch :update, params: { description: { name: "new_name" }, user_id: current_user.username, id: description.token }
        end
      ...
      context "with invalid inputs" do
        ...
        before do
          post :update, params: { description: { name: "" }, user_id: current_user.username, id: description.token }
        end
    ...
    context "with unauthenticated user" do
      before do
        ...
        post :update, params: { description: { name: "new_name" }, user_id: user.id, id: description.token }
      end
