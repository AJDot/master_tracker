describe SkillsController, type: :controller do
  ...
  describe "POST create" do
    context "with authenticated users" do
      ...
      context "with valid inputs" do
        before do
          post :create, params: { skill: { name: "new_skill" }, user_id: current_user.username }
        end
      ...
      context "with invalid inputs" do
        before do
          post :create, params: { skill: { name: "" }, user_id: current_user.username }
        end
  ...
  describe "PATCH update" do
    context "with authenticated user" do
      ...
      context "with valid inputs" do
        before do
          patch :update, params: { skill: { name: "new_name" }, user_id: current_user.username, id: skill.token }
        end
      ...
      context "with invalid inputs" do
        ...
        before do
          post :update, params: { skill: { name: "" }, user_id: current_user.username, id: skill.token }
        end
